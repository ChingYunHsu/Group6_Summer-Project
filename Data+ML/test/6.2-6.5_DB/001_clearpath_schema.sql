...
CREATE TABLE `user_reports` (
  ...
  KEY `fk_user_report_user` (`user_id`),
  KEY `fk_report_category` (`issue_type`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8329 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
