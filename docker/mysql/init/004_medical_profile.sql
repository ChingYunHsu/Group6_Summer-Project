...
CREATE TABLE IF NOT EXISTS user_medical_profiles (
  ...
  CONSTRAINT chk_user_medical_profiles_severe_allergies_array
    CHECK (severe_allergies IS NULL OR JSON_TYPE(severe_allergies) = 'ARRAY'),
  CONSTRAINT chk_user_medical_profiles_conditions_array
    CHECK (conditions IS NULL OR JSON_TYPE(conditions) = 'ARRAY'),
  CONSTRAINT chk_user_medical_profiles_medications_array
    CHECK (medications IS NULL OR JSON_TYPE(medications) = 'ARRAY'),
  CONSTRAINT chk_user_medical_profiles_emergency_contacts_array
